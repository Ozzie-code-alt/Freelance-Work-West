...
import { OSAFormCC } from './OSAFormCC';
...
const OSAFormPage = () => {
  ...
  return (
    <>
      ...
      <OSAFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default OSAFormPage;
