...
import { GuidanceFormCC } from './GuidanceFormCC';
...
const GuidanceFormPage = () => {
  ...
  return (
    <>
      ...
      <GuidanceFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default GuidanceFormPage;
