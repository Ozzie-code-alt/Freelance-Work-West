      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            exit={{ scale: 0, rotate: '0deg' }}
            onClick={(e) => e.stopPropagation()}
            className='bg-gradient-to-br from-violet-600 to-indigo-600 text-white p-4 sm:p-6 rounded-lg w-full max-w-lg h-auto shadow-xl cursor-default relative'
          >
            ...
            <Form {...form}>
              <form
                onSubmit={form.handleSubmit(onSubmit)}
                className='py-4 flex flex-col gap-4 sm:gap-8 w-full space-y-4 h-full'
              >
                <FormField
                  control={form.control}
                  name='cc1'
