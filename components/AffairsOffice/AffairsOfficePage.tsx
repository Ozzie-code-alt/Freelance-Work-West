...
import { AffairsOfficeCC } from './AffairsOfficeCC';
...
const AffairsOfficePage = () => {
  ...
  return (
    <>
      ...
      <AffairsOfficeCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default AffairsOfficePage;
