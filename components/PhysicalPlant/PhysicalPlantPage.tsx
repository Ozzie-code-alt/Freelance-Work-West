...
import { PhysicalPlantFormCC } from './PhysicalPlantFormCC';
...
const PhysicalPlantFormPage = () => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      officeVisited: 'Physical Plant Office',
      userName: '',
      servicesReceived: '',
      age: '',
      clientType: '',
  ...
  return (
    <>
      ...
      <PhysicalPlantFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default PhysicalPlantFormPage;
