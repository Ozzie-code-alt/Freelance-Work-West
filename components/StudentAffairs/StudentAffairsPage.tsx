...
import { StudentAffairsFormCC } from './StudentAffairsFormCC';
...
const StudentAffairsFormPage = () => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      officeVisited: 'Students Affairs Office',
      userName: '',
      servicesReceived: '',
      age: '',
      clientType: '',
  ...
  return (
    <>
      ...
      <StudentAffairsFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default StudentAffairsFormPage;
