...
import { CulturalFormCC } from './CulturalFormCC';
...
const CulturalFormPage = () => {
  ...
  return (
    <>
      ...
      <CulturalFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default CulturalFormPage;
