...
import { GeneralServicesFormCC } from './GeneralServicesFormCC';
...
const GeneralServicesFormPage = () => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      officeVisited: 'General Services Office',
      userName: '',
      servicesReceived: '',
      age: '',
      clientType: '',
  ...
  return (
    <>
      ...
      <GeneralServicesFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default GeneralServicesFormPage;
