...
import { SOICTFormCC } from './SOICTFormCC';
...
const SOICTFormPage = () => {
  ...
  return (
    <>
      ...
      <SOICTFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default SOICTFormPage;
