...
import { SportsOfficeFormCC } from './SportsOfficeFormCC';
...
const SportsOfficeFormPage = () => {
  ...
  return (
    <>
      ...
      <SportsOfficeFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default SportsOfficeFormPage;
