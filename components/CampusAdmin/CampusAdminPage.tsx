...
import { CampusAdminFormCC } from './CampusAdminFormCC';
...
const CampusAdminFormPage = () => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      officeVisited: 'Campus Admin Offce',
      userName: '',
      servicesReceived: '',
      age: '',
      clientType: '',
  ...
  return (
    <>
      ...
      <CampusAdminFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default CampusAdminFormPage;
