...
import { SecurityFormCC } from './SecurityFormCC';
...
const SecurityFormPage = () => {
  ...
  return (
    <>
      ...
      <SecurityFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};
