...
import { SOBMFormCC } from './SOBMFormCC';
...
const SOBMFormPage = () => {
  ...
  return (
    <>
      ...
      <SOBMFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default SOBMFormPage;
