...
import { PublicAffairsFormCC } from './PublicAffairsFormCC';
...
const PublicAffairsFormPage = () => {
  ...
  return (
    <>
      ...
      <PublicAffairsFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default PublicAffairsFormPage;
