...
import { SupplyBuildingFormCC } from './SupplyBuildingFormCC';
...
const SupplyBuildingFormPage = () => {
  ...
  return (
    <>
      ...
      <SupplyBuildingFormCC isOpen={isOpen} setIsOpen={setIsOpen} adminProps={submissionData} />
    </>
  );
};

export default SupplyBuildingFormPage;
