...
import { StudentAffairsModalOpenMore } from '@/components/StudentAffairs/OpenMoreStudentAffairs';
...
const ActionsCell: React.FC<ActionsCellProps> = ({ row }) => {
  ...
  return (
    <DropdownMenu>
      ...
      <StudentAffairsModalOpenMore isOpen={isOpen} setIsOpen={setIsOpen} formIDValue={form._id} />
    </DropdownMenu>
  );
};

export const StudentAffairscolumns: ColumnDef<FormData>[] = [
  {
    accessorKey: '_id',
    header: 'ID'
  },
