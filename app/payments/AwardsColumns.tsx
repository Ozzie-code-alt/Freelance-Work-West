...
import { AwardsModalOpenMore } from '@/components/Awards/OpenMoreAwards';
...
const ActionsCell: React.FC<ActionsCellProps> = ({ row }) => {
  ...
  return (
    <DropdownMenu>
      ...
      <AwardsModalOpenMore isOpen={isOpen} setIsOpen={setIsOpen} formIDValue={form._id} />
    </DropdownMenu>
  );
};

export const Awardscolumns: ColumnDef<FormData>[] = [
  {
    accessorKey: '_id',
    header: 'ID'
  },
