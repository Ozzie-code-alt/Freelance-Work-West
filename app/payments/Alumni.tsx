...
import { AluimniModalOpenMore } from '@/components/Alumni/OpenMoreAlumni';
...
const ActionsCell: React.FC<ActionsCellProps> = ({ row }) => {
  ...
  return (
    <DropdownMenu>
      ...
      <AluimniModalOpenMore isOpen={isOpen} setIsOpen={setIsOpen} formIDValue={form._id} />
    </DropdownMenu>
  );
};

export const Alumnicolumns: ColumnDef<FormData>[] = [
  {
    accessorKey: '_id',
    header: 'ID'
  },
