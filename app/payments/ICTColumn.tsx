...
import { ICTModalOpenMore } from '@/components/ICT/OpenMoreICT';
...
const ActionsCell: React.FC<ActionsCellProps> = ({ row }) => {
  ...
  return (
    <DropdownMenu>
      ...
      <ICTModalOpenMore isOpen={isOpen} setIsOpen={setIsOpen} formIDValue={form._id} />
    </DropdownMenu>
  );
};

export const ICTcolumns: ColumnDef<FormData>[] = [
  {
    accessorKey: '_id',
    header: 'ID'
  },
