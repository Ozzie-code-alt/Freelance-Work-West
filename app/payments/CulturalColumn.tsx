...
import { CulturalModalOpenMore } from '@/components/Cultural/OpenMoreCultural';
...
const ActionsCell: React.FC<ActionsCellProps> = ({ row }) => {
  ...
  return (
    <DropdownMenu>
      ...
      <CulturalModalOpenMore isOpen={isOpen} setIsOpen={setIsOpen} formIDValue={form._id} />
    </DropdownMenu>
  );
};

export const Culturalcolumns: ColumnDef<FormData>[] = [
  {
    accessorKey: '_id',
    header: 'ID'
  },
